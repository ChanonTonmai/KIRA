...
_start:
    # Base address loading section for cluster 0
    # Loading x18 with address 0xC8 (200)
    addi x18, x18, 200
    ...
    # Loading x20 with address 0x9C44 (40004)
    # Using lui 10 and addi -956 to create 40004
    lui x20, 10
    addi x20, x20, -956
